...
import { RecordedClass } from '@/lib/mockClasses';

export default function ClassCard({ session }: { session: RecordedClass }) {
  return (
    <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all group">
      ...
      <a
        ...
        className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gray-50 text-foreground/70 font-bold group-hover:bg-primary group-hover:text-white transition-all"
      >
