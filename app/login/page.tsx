  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (success) {
        ...
        setError('Invalid email or password. Hint: student@example.com / password123');
      }
    } catch (err) {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-heading font-bold text-foreground">Student Login</h1>
          <p className="text-foreground/60 mt-2">Access your recorded classes and materials.</p>
        </div>
